...
class RPR0521RS:
    ...
    def __init__(self, i2c):
        ...
        self.i2c.writeto_mem(self.ADDR, self.REG_MODE_CONTROL, bytes([0x00]))
        time.sleep_ms(50)

        self.i2c.writeto_mem(self.ADDR, self.REG_MODE_CONTROL, bytes([0x89, 0x02]))
